...
//
//	private DetailDto testDto = new DetailDto();
//	private BindingResult bindingResult = new BindException(testDto, "DetailDto");
//
//	@Autowired
//	Validator validator;
//
//	@Autowired
//	DetailController target;
//
//	@Before
//	public void setup() {
...
//
//	/**
//	 * detail.htmlに遷移するかテスト
//	 */
//	@Test
//	public void test1() throws Exception {
//		mockMvc.perform(get("/detail/82")).andExpect(view().name("detail"));
//		}
//
//	/**
//	 * Postの処理が成功した時のテスト
...
//
//		mockMvc.perform((post("/detail")).flashAttr("detailDto", testDto))
//		.andExpect(view().name("detail"))
//		.andExpect(model().attribute("result",testDto))
//		.andExpect(model().attribute("getMessage","修正完了しました。"));
//	}
//	/**
...
//		mockMvc.perform((post("/detail")).flashAttr("detailDto", testDto))
//		.andExpect(view().name("detail"))
//		.andExpect(model().attribute("validationError", hasItem("名前は必須です。")))
//		.andExpect(model().attribute("result",testDto));
//	}
//
//	/**
...
//		assertThat(bindingResult.getFieldError().getDefaultMessage(), is("備考は200字以内で入力してください。"));
//	}
//}
